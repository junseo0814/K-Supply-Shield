...
# 광업 산업 전국 총생산액(조원) — 통계청 광업제조업조사, 전국·광업(05~08), 2019년 기준
# (data/kosis 산업별 생산액_....xlsx, 통계표ID DT_1FS1004). 시뮬레이션 결과의 '광산품'
# 생산손실이 이 산업 전체에서 차지하는 비중(%)을 보여주기 위한 벤치마크 값 — 계산 로직에는
# 영향 없음. 2019년 이후 갱신치는 미확보(추후 KOSIS에서 최신 연도로 재다운로드 가능).
MINING_SECTOR_TOTAL_PROD_TRILLION = 3.193755
